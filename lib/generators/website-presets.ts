...
export type ThemeMode = "dark" | "light" | "warm" | "soft" | "industrial" | "editorial" | "portfolio";
...
export interface WebsitePreset {
  ...
  buttonStyle: "quiet" | "rounded" | "sharp" | "cinematic" | "technical";
  sectionRhythm: "open" | "compact" | "measured" | "immersive" | "structured";
  trustTone: string;
  sectionOrder: string[];
  theme: WebsiteTheme;
  tone: string;
...
export const websitePresets: Record<WebsitePresetName, WebsitePreset> = {
  "Luxury Editorial": {
    ...
    buttonStyle: "rounded",
    sectionRhythm: "open",
    trustTone: "crafted, proof-ready, and premium",
    sectionOrder: ["hero", "credibility", "services", "experience", "gallery", "process"],
    theme: { pageBg: "#08090b", surface: "#14151a", surfaceAlt: "#0b0c0f", text: "#f8f5ee", muted: "#b9b5ad", heroOverlay: "linear-gradient(90deg, rgba(5,6,8,.98) 5%, rgba(5,6,8,.82) 46%, rgba(5,6,8,.2) 78%)", heroText: "#f8f5ee", cardBg: "linear-gradient(145deg, rgba(27,27,31,.88), rgba(11,11,13,.84))", sectionBg: "#0b0c0f", border: "rgba(255,255,255,.12)", navBg: "rgba(7,8,11,.88)", displayFont: serifDisplay, bodyFont, shadow: "0 30px 90px rgba(0,0,0,.45)", cardRadius: "24px", buttonRadius: "999px", sectionPadding: "112px", heroMinHeight: "960px" },
  ...
  "Clean Local Business": {
    ...
    trustTone: "approachable, local, and easy to contact",
    sectionOrder: ["hero", "services", "credibility", "process", "experience", "gallery"],
    theme: { pageBg: "#f7faf8", surface: "#ffffff", surfaceAlt: "#eef5f1", text: "#17201c", muted: "#5f6f67", heroOverlay: "linear-gradient(90deg, rgba(247,250,248,.98) 0%, rgba(247,250,248,.94) 48%, rgba(247,250,248,.2) 74%)", heroText: "#17201c", cardBg: "#ffffff", sectionBg: "#eef5f1", border: "rgba(23,32,28,.13)", navBg: "rgba(247,250,248,.92)", displayFont: sansDisplay, bodyFont, shadow: "0 24px 70px rgba(38,70,53,.12)", cardRadius: "18px", buttonRadius: "16px", sectionPadding: "84px", heroMinHeight: "790px" },
  ...
  "Bold Modern": {
    ...
    buttonStyle: "sharp",
    sectionRhythm: "immersive",
    trustTone: "bold, direct, and action-led",
    sectionOrder: ["hero", "services", "transformation", "credibility", "gallery", "process"],
    theme: { pageBg: "#07070a", surface: "#17171d", surfaceAlt: "#0d0d12", text: "#ffffff", muted: "#b8b8c2", heroOverlay: "linear-gradient(90deg, rgba(4,4,7,.96), rgba(4,4,7,.7) 52%, rgba(4,4,7,.12))", heroText: "#ffffff", cardBg: "#17171d", sectionBg: "#0d0d12", border: "rgba(255,255,255,.14)", navBg: "rgba(7,7,10,.9)", displayFont: sansDisplay, bodyFont, shadow: "0 32px 90px rgba(0,0,0,.5)", cardRadius: "14px", buttonRadius: "12px", sectionPadding: "104px", heroMinHeight: "940px" },
  ...
  "Soft Wellness": {
    ...
    trustTone: "calm, gentle, and reassuring",
    sectionOrder: ["hero", "credibility", "experience", "services", "process", "gallery"],
    theme: { pageBg: "#f5f3ed", surface: "#fffdf8", surfaceAlt: "#e9efe9", text: "#26342f", muted: "#68766f", heroOverlay: "linear-gradient(90deg, rgba(245,243,237,.98), rgba(245,243,237,.9) 50%, rgba(245,243,237,.12) 78%)", heroText: "#26342f", cardBg: "#fffdf8", sectionBg: "#e9efe9", border: "rgba(38,52,47,.12)", navBg: "rgba(245,243,237,.92)", displayFont: serifDisplay, bodyFont, shadow: "0 24px 65px rgba(62,82,72,.13)", cardRadius: "34px", buttonRadius: "999px", sectionPadding: "96px", heroMinHeight: "800px" },
  ...
  "Industrial Premium": {
    ...
    colorIntensity: "balanced",
    buttonStyle: "sharp",
    sectionRhythm: "structured",
    trustTone: "capable, practical, and process-led",
    sectionOrder: ["hero", "services", "process", "transformation", "gallery", "credibility"],
    theme: { pageBg: "#111417", surface: "#1d2227", surfaceAlt: "#171b1f", text: "#f4f6f7", muted: "#adb5bd", heroOverlay: "linear-gradient(90deg, rgba(13,16,19,.98), rgba(13,16,19,.78) 50%, rgba(13,16,19,.2))", heroText: "#f4f6f7", cardBg: "#1b2025", sectionBg: "#171b1f", border: "rgba(255,255,255,.14)", navBg: "rgba(17,20,23,.92)", displayFont: sansDisplay, bodyFont, shadow: "0 26px 70px rgba(0,0,0,.38)", cardRadius: "10px", buttonRadius: "8px", sectionPadding: "92px", heroMinHeight: "850px" },
  ...
  "Music / Artist Portfolio": {
    ...
    colorIntensity: "vivid",
    buttonStyle: "cinematic",
    sectionRhythm: "immersive",
    trustTone: "expressive, visual, and booking-focused",
    sectionOrder: ["hero", "gallery", "experience", "services", "credibility", "process"],
    theme: { pageBg: "#08070d", surface: "#171321", surfaceAlt: "#100c17", text: "#fff9ff", muted: "#c4b9cc", heroOverlay: "linear-gradient(90deg, rgba(8,7,13,.96), rgba(8,7,13,.64) 48%, rgba(8,7,13,.16))", heroText: "#fff9ff", cardBg: "linear-gradient(145deg, rgba(31,22,43,.9), rgba(13,10,19,.86))", sectionBg: "#100c17", border: "rgba(255,255,255,.14)", navBg: "rgba(8,7,13,.9)", displayFont: serifDisplay, bodyFont, shadow: "0 34px 100px rgba(0,0,0,.5)", cardRadius: "28px", buttonRadius: "999px", sectionPadding: "118px", heroMinHeight: "1020px" },
  ...
  "Memorial Tribute": {
    ...
    buttonStyle: "quiet",
    sectionRhythm: "measured",
    trustTone: "respectful, private, and supportive",
    sectionOrder: ["hero", "credibility", "services", "process", "experience", "gallery"],
    theme: { pageBg: "#f3f0e8", surface: "#fbf9f4", surfaceAlt: "#e8e8df", text: "#303830", muted: "#6f746b", heroOverlay: "linear-gradient(90deg, rgba(243,240,232,.98), rgba(243,240,232,.9) 55%, rgba(243,240,232,.28))", heroText: "#303830", cardBg: "#fbf9f4", sectionBg: "#e8e8df", border: "rgba(48,56,48,.12)", navBg: "rgba(243,240,232,.94)", displayFont: serifDisplay, bodyFont, shadow: "0 22px 60px rgba(64,70,58,.12)", cardRadius: "6px", buttonRadius: "999px", sectionPadding: "88px", heroMinHeight: "800px" },
  ...
  "Restaurant Experience": {
    ...
    buttonStyle: "rounded",
    sectionRhythm: "immersive",
    trustTone: "warm, sensory, and hospitality-focused",
    sectionOrder: ["hero", "services", "gallery", "experience", "process", "credibility"],
    theme: { pageBg: "#170e0b", surface: "#271714", surfaceAlt: "#20120f", text: "#fff8ed", muted: "#d0bfb2", heroOverlay: "linear-gradient(90deg, rgba(23,14,11,.97), rgba(23,14,11,.72) 48%, rgba(23,14,11,.18))", heroText: "#fff8ed", cardBg: "#271714", sectionBg: "#20120f", border: "rgba(255,239,220,.14)", navBg: "rgba(23,14,11,.92)", displayFont: serifDisplay, bodyFont, shadow: "0 30px 90px rgba(0,0,0,.42)", cardRadius: "22px", buttonRadius: "999px", sectionPadding: "106px", heroMinHeight: "940px" },
  ...
  "3D Printing Studio": {
    ...
    sectionRhythm: "structured",
    trustTone: "technical, inventive, and quote-ready",
    sectionOrder: ["hero", "services", "transformation", "process", "gallery", "credibility"],
    theme: { pageBg: "#090b14", surface: "#121827", surfaceAlt: "#0d1220", text: "#f4f7ff", muted: "#aeb8ce", heroOverlay: "linear-gradient(90deg, rgba(9,11,20,.97), rgba(9,11,20,.7) 50%, rgba(9,11,20,.12))", heroText: "#f4f7ff", cardBg: "#111827", sectionBg: "#0d1220", border: "rgba(103,232,249,.18)", navBg: "rgba(9,11,20,.92)", displayFont: sansDisplay, bodyFont, shadow: "0 28px 90px rgba(3,7,18,.52)", cardRadius: "14px", buttonRadius: "10px", sectionPadding: "94px", heroMinHeight: "880px" },
  ...
  "Professional Trust": {
    ...
    buttonStyle: "quiet",
    sectionRhythm: "compact",
    trustTone: "measured, credible, and consultation-focused",
    sectionOrder: ["hero", "credibility", "services", "process", "experience", "gallery"],
    theme: { pageBg: "#f4f7fa", surface: "#ffffff", surfaceAlt: "#eaf0f5", text: "#17243a", muted: "#617086", heroOverlay: "linear-gradient(90deg, rgba(244,247,250,.99), rgba(244,247,250,.94) 50%, rgba(244,247,250,.16) 78%)", heroText: "#17243a", cardBg: "#ffffff", sectionBg: "#eaf0f5", border: "rgba(23,36,58,.13)", navBg: "rgba(244,247,250,.94)", displayFont: serifDisplay, bodyFont, shadow: "0 24px 70px rgba(31,54,80,.13)", cardRadius: "14px", buttonRadius: "10px", sectionPadding: "82px", heroMinHeight: "760px" },
