...
export function buttonClass(variant: ButtonVariant = "primary", className?: string) {
  const variants: Record<ButtonVariant, string> = {
    primary:
      "border-brand-600 bg-brand-600 text-white shadow-[0_10px_24px_rgba(90,73,239,.22)] hover:-translate-y-0.5 hover:bg-brand-700",
    secondary: "border-ink-950 bg-ink-950 text-white hover:-translate-y-0.5 hover:bg-ink-800",
